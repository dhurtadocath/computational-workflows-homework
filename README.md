...
```
# Add your commands here
# sudo docker build . -t dhurtadocath/computational-workflows
# sudo docker login
# sudo docker push dhurtadocath/computational-workflows
```
...
```
# Add your commands here
# sudo docker run -ti -v $(pwd):/root/shared dhurtadocath/computational-workflows
```
...
```
# Add your commands here
# sudo cp ../computational-workflows/python/unit_testing/wallet/* .
```
